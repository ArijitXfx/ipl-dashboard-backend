...
import com.arijit.ipldashboard.util.MatchDataProcessor;
...
public class BatchConfig {
    ...
    public FlatFileItemReader<MatchInput> reader() {
        final String[] fields = {"id","city","date","player_of_match","venue","neutral_venue",
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql("INSERT INTO match (id,city,date,player_of_match,venue,team1,team2,toss_winner," +
                        ...
                        ":tossDecision,:matchWinner,:result,:resultMargin,:method,:umpire1,:umpire2)")
